...
const Sprite = function(ctx, x, y) {
    ...
    const update = function(time) {
        ...
        if(sequence.timing <= (time - lastUpdate)){ //check if we need to move to next sprite
            index++;
            
            if(sequence.loop == true){ //if true then need to repeat the sequence animation =lecture notes
